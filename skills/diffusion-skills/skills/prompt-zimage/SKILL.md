...
- **Z-Image-Edit:** keep instructions surgical — 20–60 words. Describe what changes, name what's preserved.
...
- **Specify font style** when it matters: "elegant English serif", "modern Chinese heiti", "traditional brush calligraphy"
...
- `CEO` → defaults to white male in a suit
