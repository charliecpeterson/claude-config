...
- `heart` (834,322 posts) — // ♥ ♡ (see also [b]Playing Card[/b])
- `sweatdrop` (306,984 posts)
- `flying_sweatdrops` (119,684 posts)
- `?` (98,397 posts)
- `cross` (97,760 posts) — h4#cross.  symbols
- `anger_vein` (74,985 posts)
- `...` (73,268 posts)
- `spoken_heart` (72,575 posts)
- `musical_note` (71,672 posts)
- `crescent` (69,623 posts) — // ☾
- `^^^` (64,004 posts)
- `!` (53,105 posts)
- `spoken_ellipsis` (50,754 posts)
- `notice_lines` (48,539 posts)
- `!?` (35,979 posts)
- `spoken_question_mark` (29,040 posts)
- `+++` (26,631 posts)
- `eighth_note` (25,950 posts) — // ♪
- `squiggle` (22,658 posts)
- `spoken_exclamation_mark` (19,265 posts)
- `puff_of_air` (18,268 posts)
- `squeans` (15,547 posts)
- `playing_card` (15,443 posts) — h4#play_card.
- `spoken_musical_note` (12,351 posts)
- `yin_yang` (11,806 posts) — // ☯
- `orb` (11,172 posts)
- `beamed_eighth_notes` (10,883 posts) — // ♫
- `iron_cross` (10,727 posts)
- `spoken_blush` (10,539 posts)
- `barcode` (10,249 posts)
- `lightning_bolt_symbol` (9,992 posts) — // ⚡
- `triangle` (8,970 posts) — // ▲
- `road_sign` (8,363 posts) — h4#road_signs. s
- `spoken_squiggle` (7,681 posts)
- `pentagram` (7,643 posts) — (5 points) // ⛥
- `spoken_interrobang` (7,435 posts)
- `spoken_anger_vein` (7,329 posts)
- `circle` (7,185 posts) — // ○
- `command_spell` (7,149 posts)
- `latin_cross` (6,486 posts) — // †
- `treble_clef` (6,268 posts) — // 𝄞
- `sun_symbol` (5,669 posts)
- `musical_staff` (4,827 posts) — // 𝄚𝄚𝄚𝄚𝄚
- `skull_and_crossbones` (4,705 posts) — // ☠
- `quarter_note` (4,582 posts) — // ♩
- `japari_symbol` (4,558 posts)
- `inverted_cross` (4,182 posts)
- `cube` (4,021 posts)
- `hexagram` (3,964 posts) — (6 points)
- `battery_indicator` (3,955 posts)
- `mars_symbol` (3,955 posts) — (Male symbol) // ♂
- `smiley_face` (3,914 posts)
- `x_(symbol)` (3,710 posts)
- `spoken_sweatdrop` (3,631 posts)
- `power_symbol` (3,585 posts)
- `beamed_sixteenth_notes` (3,519 posts) — // ♬
- `qr_code` (3,337 posts)
- `red_cross` (3,328 posts)
- `konohagakure_symbol` (3,231 posts)
- `venus_symbol` (3,116 posts) — (Female symbol) // ♀
- `broken_heart` (3,073 posts)
- `hammer_and_sickle` (2,585 posts) — // ☭
- `ankh` (2,491 posts) — // ☥
- `runes` (2,412 posts)
- `arrow_through_heart` (2,392 posts)
- `hexagon` (2,289 posts)
- `warning_sign` (2,008 posts) — // ⚠️
- `androgyne_symbol` (2,007 posts) — // ⚨ ⚦ ⚩
- `bus_stop` (1,944 posts)
- `bass_clef` (1,879 posts) — // 𝄢
- `oda_uri` (1,790 posts)
- `infinity_symbol` (1,766 posts) — // ∞
- `star_of_david` (1,674 posts) — // ✡
- `peace_symbol` (1,583 posts) — // ☮
- `kikumon` (1,490 posts)
- `zodiac` (1,428 posts) — // ♈♉♊♋♌♍♎♏♐♑♒♓
- `survey_corps_(emblem)` (1,423 posts)
- `radiation_symbol` (1,390 posts) — // ☢
- `jolly_roger` (1,356 posts)
- `st._gloriana's_(emblem)` (1,321 posts)
- `swastika` (1,318 posts) — // 卐 卍
- `trigram` (1,248 posts)
- `red_star` (1,227 posts)
- `square` (1,181 posts)
- `dollar_sign` (1,180 posts) — / $
- `fleur-de-lis` (1,154 posts) — // ⚜
- `sixteenth_note` (1,103 posts) — // 𝅘𝅥𝅯
- `comedic_sweatdrop` (1,022 posts)
- `rhine_lab_logo` (960 posts)
- `shout_lines` (927 posts)
- `spoken_x` (918 posts)
- `stop_sign` (908 posts)
- `training_corps_(emblem)` (877 posts)
- `greek_cross` (857 posts) — // +
- `half_note` (847 posts) — // 𝅗𝅥
- `ooarai_(emblem)` (820 posts)
- `plus_sign` (791 posts) — // +
- `no_symbol` (782 posts) — // ⃠
- `yen_sign` (737 posts) — / ¥
- `sakura_empire_(emblem)` (692 posts)
- `male-female_symbol` (654 posts) — // ⚥
- `iron_blood_(emblem)` (631 posts)
- `reichsadler` (627 posts)
- `star_of_life` (614 posts)
- `sharp_sign` (591 posts) — // ♯
- `spoken_star` (589 posts)
- `no_entry_sign` (589 posts) — // ⛔
- `pravda_(emblem)` (572 posts)
- `playing_card_theme` (561 posts)
- `eagle_union_(emblem)` (541 posts)
- `small_stellated_dodecahedron` (522 posts)
- `kuromorimine_(emblem)` (502 posts)
- `rectangle` (481 posts)
- `penguin_logistics_logo` (480 posts)
- `recycling_symbol` (467 posts) — // ♻
- `stellated_octahedron` (456 posts)
- `no_smoking` (451 posts) — // 🚭
- `seven-segment_display` (450 posts)
- `octagram` (438 posts) — (8 points) // ✷
- `flat_sign` (410 posts) — // ♭
- `wi-fi_symbol` (406 posts)
- `japanese_tankery_league_(emblem)` (389 posts)
- `celtic_cross` (386 posts) — // 🕈
- `interlocked_mars_and_venus_symbols` (371 posts) — // ⚤
- `totenkopf` (370 posts)
...
- `wheel_of_dharma` (136 posts) — // ☸️
- `vichya_dominion_(emblem)` (130 posts)
- `siegrunen` (125 posts) — // ᛋᛋ
- `signal_bar` (120 posts)
- `iwagakure_symbol` (114 posts)
- `pi_(math)` (113 posts) — // π
- `one_way_sign` (113 posts)
...
- `two-legged_horse_(kanji)` (97 posts)
- `prism` (96 posts)
...
- `octagon` (88 posts)
- `equal_sign` (87 posts) — // =
- `amegakure_symbol` (87 posts)
- `anarchy_symbol` (85 posts) — // Ⓐ
