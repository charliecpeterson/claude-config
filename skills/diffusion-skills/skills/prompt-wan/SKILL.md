...
```
morphing, warping, distortion, face deformation, eye distortion, identity drift, flickering, jittering, sudden changes, inconsistent lighting, color shifting, scale changes, new elements appearing, compositional changes, bad anatomy, extra limbs
```
...
- Specify the reference images' roles: "Reference 1 is the main character, reference 2 is the environment, reference 3 is the product"
- For branded work, include HEX codes: "primary color #1A3A6B, accent #F4B400"
