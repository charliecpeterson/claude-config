...
- [ ] **God object / God file** — one file or class everything routes through (e.g. a 2000+ line "manager" that is the database *and* the search engine *and* the AI client). The single strongest rebuild signal.
